    ...
    <div class="container-index">
        <div class="filtres">
            <div class="row g-5">
                <div class="col-lg-6 filter-left custom">
                    ...
                    <select id="category-filter" class="select-filter" name="categorie">
        ...
        <div class="photo-grid">
            ...
            $args = array(
                ...
                'posts_per_page' => 8, // Récupérer seulement 8 photos 
                'orderby' => 'date', // Trier par date
                'order' => 'DESC', // Photo de la plus récente à la plus ancienne
